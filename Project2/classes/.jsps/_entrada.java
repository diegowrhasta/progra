...
public class _entrada extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:16^1*/      {
        ...
        __jsp_taghandler_2.setAction("/entrada");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:17^1*/            {
              ...
              __jsp_taghandler_3.setKey("idusuario.prompt");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:19^1*/            {
              ...
              __jsp_taghandler_4.setProperty("idusuario");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:21^1*/            {
              ...
              __jsp_taghandler_5.setKey("clave.prompt");
          ...
          /*@lineinfo:translated-code*//*@lineinfo:23^16*/          } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
      ...
      /*@lineinfo:user-code*//*@lineinfo:29^1*/      out.print( new java.util.Date() );
      /*@lineinfo:generated-code*/
